...
__all__ = ['read_data', 'get_distributed_data_cfgs', 'get_tff_dataset']
...
def get_tff_dataset(dataset_name, sub_data):
    if dataset_name == 'femnist' or dataset_name == 'emnist':
        # 载入所有的 62个类别, 3,400 users, 62 label classes
        return tff.simulation.datasets.emnist.load_data(only_digits=False)
    else:
        raise ValueError('Not implement:', dataset_name)
