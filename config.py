...
import argparse
DATASETS = ['emnist']
TRAINERS_TONAMES = {'fedavg': 'FedAvg',}
...
MODEL_PARAMS = {
    ...
    'emnist.cnn': {'num_class': 62, 'image_size': 28}
}
...
def base_options():
    ...
    parser.add_argument('--model',
                        ...
                        type=str,
                        default='emnist')
    parser.add_argument('--max_clients_num',
                        help='Maximum number of clients selected from tff dataset',
                        type=int,
                        required=True)
